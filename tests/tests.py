...
class TestSpotifyClient(unittest.TestCase):
    def test_get_user_info(self):
        ...
        mock_user = "bezamufc"
        sp = SpotifyClient("bezamufc", path=None, auth_manager=auth_manager_mock)
    ...
    def test_generate_token(self):
        ...
        auth_manager_mock.cache_handler = cache_handler_mock
        auth_manager_mock.get_cached_token.return_value = {"access_token": "fake_access_token"}
        client = SpotifyClient("testuser", path=None, auth_manager=auth_manager_mock)
    ...
    def test_select_all_playlists(self):
        ...
        sp = SpotifyClient("testuser", path=None, auth_manager=auth_manager_mock)
    ...
    def test_get_user_choices(self, mock_input):
        ...
        sp = SpotifyClient("testuser", path=None, transfer_all=False, auth_manager=auth_manager_mock)
